    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="bg-white rounded h-100 p-4">
                <h5 class="m-0 text-light">Data Golongan</h5>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <a href='".URL."/golongan/hapusGolongan/$row[gol_id]' class='btn btn-danger' style='width:100px !important;'><i class='fa fa-trash'></i> Hapus</a>
                                            </td>
                                        </tr>
                                    </tbody> 
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="http://fadhlanhussainisiregar.gyar-indonesia.com/">Copyright 2022</a>, Fadhlan Hussaini Siregar. 
                        </div>
