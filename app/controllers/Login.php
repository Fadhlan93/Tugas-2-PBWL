        ...
        public function formLogin(){
            ...
            if($res == "gagal"){
                ...
                if($res['user_role'] == 1){
                    ...
                    header("location:http://127.0.0.1:8080/Tugas-2-PBWL/admin");    
                }
                elseif($res['user_role'] == 2){
                    $_SESSION['member']  = "Member";
                    header("location:http://127.0.0.1:8080/Tugas-2-PBWL/member");
                }
                else{
                    $data['user_login'] = 'Username atau Password anda salah!';
                    //header("location:http://127.0.0.1:8080/Tugas-2-PBWL/login");
                    $this->home('http://127.0.0.1:8080/Tugas-2-PBWL/login', $data);
                }   
